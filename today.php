...
<p>
    <?php
        ...
        fclose($handle);
        echo "Today's date is: ",date('l, F jS Y.'),"<br>","Your IP number is: ",$ip_form,"<br>","Your host name is: ",$host_form,"<br>","Your country code is: ",$country_form;
        ...
        fclose($handle);
        echo "Today's date is: ",date('l, F jS Y.'),"<br>","Your IP number is: ",$ip,"<br>","Your host name is: ",$host,"<br>","Your country code is: ",$country;
        //phpinfo();
    ?>
</p>
</body>
